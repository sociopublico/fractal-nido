    ...
    >
      <div className="sticky top-0 min-h-screen flex items-center py-16">
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="mt-10 grid grid-cols-4 gap-8">
            {dimensions.map((dimension, index) => {
              ...
              return (
                ...
                >
                  <span
                    className="absolute right-0 top-0 text-black px-3 py-1 text-md font-medium tracking-wide transition-colors duration-500 bg-[#0030870D]"
                  >
                    {dimension.label}
                  </span>

                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl text-cyan transition-transform duration-700">
                    <Icon />
                  </div>
                  <p className="mt-3 text-md leading-tight text-black" dangerouslySetInnerHTML={{ __html: dimension.description }} />
                </article>
              );
            })}
          </div>
          ...
          <div className="mt-10">
            <div className="relative h-[2px] w-full bg-[#C4CDD7] overflow-visible">
              <div
                className="absolute left-0 top-0 h-full bg-cyan"
...
<path d="M22 16V12H26V16H30V20H26V24H22V20H18V16H22Z" fill="#00A1DE"/>
<path d="M16 40V28H32V40H38V8H10V40H16ZM20 40H28V32H20V40ZM42 40H46V44H2V40H6V6C6 4.89544 6.89544 4 8 4H40C41.1046 4 42 4.89544 42 6V40Z" fill="#003087"/>
</svg>
...
function EducacionIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 22.6666L0 18L24 4L48 18L44 20.3334L40 22.6666V36.0226L39.5548 36.5728C35.8914 41.0998 30.2836 44 24 44C17.7163 44 12.1086 41.0998 8.44526 36.5728L8 36.0226V22.6666ZM12 25V34.5834C14.9344 37.908 19.2222 40 24 40C28.7778 40 33.0656 37.908 36 34.5834V25L24 32L12 25ZM7.93854 18L24 27.3692L40.0614 18L24 8.63082L7.93854 18Z" fill="#003087"/>
...
function EspaciosVerdesIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M41.996 6V10C41.996 17.732 35.728 24 27.996 24H25.996V26H35.996V40C35.996 42.2092 34.2052 44 31.996 44H15.9961C13.787 44 11.9961 42.2092 11.9961 40V26H21.996V20C21.996 12.268 28.2642 6 35.996 6H41.996Z" fill="#003087"/>
<path d="M10.9961 4C16.0533 4 20.526 6.50272 23.2432 10.3372C21.2052 13.0217 19.9961 16.3696 19.9961 20V22H18.9961C10.7118 22 3.99609 15.2843 3.99609 7V4H10.9961Z" fill="#00A1DE"/>
</svg>
...
function ContextoIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M40 40C40 41.1046 39.1046 42 38 42H10C8.89544 42 8 41.1046 8 40V22H2L22.6546 3.22301C23.4174 2.52951 24.5826 2.52951 25.3454 3.22301L46 22H40V40ZM36 38V18.3149L24 7.40581L12 18.3149V38H36Z" fill="#003087"/>
<path d="M24.0004 34L17.2829 27.2824C15.5255 25.525 15.5255 22.6758 17.2829 20.9184C19.0402 19.1611 21.8894 19.1611 23.6468 20.9184L24.0004 21.272L24.354 20.9184C26.1114 19.1611 28.9606 19.1611 30.718 20.9184C32.4752 22.6758 32.4752 25.525 30.718 27.2824L24.0004 34Z" fill="#00A1DE"/>
</svg>
