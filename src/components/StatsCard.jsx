  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col md:flex-row">
        <div className="w-full bg-menorIngreso p-6 text-3xl font-bold text-white max-md:p-4 max-md:text-2xl md:w-1/2">
          <img src={withBase('arrow.png')} alt="" className="mb-4 h-6 w-6 rotate-180" />
          <p className="font-bold">{numMenorIngreso ?? '—'} de cada {total ?? '—'}</p>
        ...
        <div className="w-full bg-mayorIngreso p-6 text-3xl font-bold text-white max-md:p-4 max-md:text-2xl md:w-1/2">
          <img src={withBase('arrow.png')} alt="" className="mb-4 h-6 w-6" />
          <p className="font-bold">{numMayorIngreso ?? '—'} de cada {total ?? '—'}</p>
